---
title: "Probaility and Probability Distributions"
...
## More on the Two Die Experiment
...
* Example is a coin tossed once or a fight between me and MayWeather where the probability of him winning is 0.9 and I losing is 0.1.
...
* A distribution is said to be Binomial if the following are satisfied;
  ...
  - The probability of scuccess and failure is same for all trials.
